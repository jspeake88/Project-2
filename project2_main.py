...
# 'Employee()' class that will be used to create the objects used in this program to
# archive the input collected from the end-user and fetch the information to be output
...
# 'main()' will create three iterations of the 'Employee()' class
# each iteration will contain input provided by the end-user to be displayed in a
# table format back to the end-user in a later defined function
def main():
